---
layout: default
title: Archived v2 documentation
description: Historical v2 README for WordPress Playground PR Preview.
permalink: /v2/
---
...
This page preserves the v2 README for older installations. New setups should use the [current v3 documentation](../) or the [migration guide](../migration/).
