...
layout: default
title: README
description: Current v3 documentation for WordPress Playground PR Preview.
permalink: /
---

{% raw %}

<div class="callout-grid" aria-label="Documentation shortcuts">
  <a class="callout-card" href="./#quick-start"><strong>Quick start</strong><span>Choose no-build or build-step setup.</span></a>
  <a class="callout-card" href="./migration/"><strong>Migrate from v2</strong><span>Replace older artifact workflows with v3 reusable workflows.</span></a>
  <a class="callout-card" href="./v2/"><strong>Archived v2 docs</strong><span>Historical documentation for older setups.</span></a>
</div>
